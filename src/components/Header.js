...
import mainlogo from "../assets/Asset 1.svg"
export const Header = () => {
      ...
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 border-b-2 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">NewsMates</span>
          </Link>
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <NavLink to="/" className={({ isActive }) => isActive ? activeClass : inActiveClass} aria-current="page">Highlights</NavLink>
              </li>
              <li>
                <NavLink to="/business" className={({ isActive }) => isActive ? activeClass : inActiveClass}>Business</NavLink>
              </li>
              <li>
                <NavLink to="/entertainment" className={({ isActive }) => isActive ? activeClass : inActiveClass}>Entertainment</NavLink>
              </li>
              <li>
                <NavLink to="/health" className={({ isActive }) => isActive ? activeClass : inActiveClass}>Health</NavLink>
              </li>
              <li>
                <NavLink to="/sports" className={({ isActive }) => isActive ? activeClass : inActiveClass}>Sports</NavLink>
              </li>
              <li>
